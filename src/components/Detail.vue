<template>
            ...
            <el-card :body-style="{padding:'15px'}" >
                ...
                <el-row class="card-content">
                    <el-row style="line-height: 34px;margin-top: 10px;margin-bottom:10px;text-align: justify;font-size: large;font-weight: bold;">
                     ...
                     <el-col :span="5" :push="10"><el-button type="primary" round @click="submitApplication">申请组队</el-button></el-col>
  ...
  export default {
    ...
    mounted(){
      fetch("http://127.0.0.1:8081/api/schedule/"+this.$route.params.scheduleId)
